    ...
    <div class="seers-cms-consent-banner-general-container">
            ...
            <div class="seers-cms-consent-banner-general-settings-section">
                ...
                <div class="seers-cms-consent-banner-general-custom-dropdown">
                    ...
                    <ul class="seers-cms-consent-banner-general-dropdown-options">
                        ...
                        <li class="customizeSeersBtn" name="regulation" data-loading-text="Please Wait..." data-tab="ByRegion">
                            <input type="radio" id="ccpa" name="consent" value="ccpa" class="seers-paid-feature-opener" name="regulation">
                            <label for="ccpa" class="" name="regulation">Global Privacy Law</label>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="seers-cms-consent-banner-general-settings-section">
                ...
                <div class="seers-cms-consent-banner-general-custom-dropdown">
                    ...
                    <ul class="seers-cms-consent-banner-general-dropdown-options">
                        ...
                        <li  class="customizeSeersBtn" name="regulation"  data-loading-text="Please Wait..." data-tab="BannerContent">
                            <input type="radio" id="add-other" name="language" value="add-other"  class="seers-paid-feature-opener" name="regulation">
                            <label for="add-other" class="seers-paid-feature-opener" name="regulation">Add Other</label>
                        </li>
        ...
        <div class="seers-cms-consent-banner-general-geo-target-section">
            ...
            <div class="seers-cms-consent-banner-general-radio-group">
                <label class="seers-paid-feature-opener customizeSeersBtn" name="regulation"  data-loading-text="Please Wait..." data-tab="ByRegion">
                    <input class="seers-paid-feature-opener" disabled name="regulation" type="radio" name="geo-target" value="worldwide">Worldwide
                </label>
                <label class="seers-paid-feature-opener customizeSeersBtn" name="regulation"  data-loading-text="Please Wait..." data-tab="ByRegion">
                    <input class="seers-paid-feature-opener" disabled name="regulation" type="radio" name="geo-target" value="uk-eu">UK & EU Countries
                </label>
                <label class="seers-paid-feature-opener customizeSeersBtn" name="regulation"  data-loading-text="Please Wait..." data-tab="ByRegion">
                    <input class="seers-paid-feature-opener" disabled name="regulation" type="radio" name="geo-target" value="auto">Auto Regional Detection
                </label>
                <label class="seers-paid-feature-opener customizeSeersBtn" name="regulation"  data-loading-text="Please Wait..." data-tab="ByRegion">
                    <input class="seers-paid-feature-opener" disabled name="regulation" type="radio" name="geo-target" value="other-countries">Other Countries
                </label>
            </div>
        </div>
        <div class="seers-cms-appearance-settings-setting seers-cms-general-language-auto customizeSeersBtn"  data-loading-text="Please Wait..." data-tab="Preferences">
                ...
                <input type="checkbox" id="language-auto-regional-detection" class="seers-paid-feature-opener seers-cms-general-language-auto-toggle seers-get-premium" name="languageautoregionaldetection">
            </div> --}}
            <div class="seers-cms-appearance-settings-input-field ">
                <div class="toggle-frameworks-switch" id="language-auto-regional-detection" name="languageautoregionaldetection"></div>
            </div>
            </div>
